...
####################################################
#!!
#! @description:                 - Deletes an existing inventory folder in a Datacenter as seen in vCenter
#!                                  "Inventory > VMs and Templates" view.  Optionally this operation will also delete
#!                                  any VMs contained in the folder is it is not empty.
...
#!                                 Default: 800
#! @input remove_children:       - Recursively delete any child folders and VMs as well.  If false, the folder must be
#!                                  empty before it can be deleted.  If true the folder and all of the contents will be
#!                                  deleted.
#!                                 Valid values: "true", "false"
#!                                 Default value: "false"
...
#! @output return_result:        - This is the primary output. Descriptive result of the operation. Reason for error on
#!                                  failure.
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.vm.DeleteVMFolder
   outputs: 
