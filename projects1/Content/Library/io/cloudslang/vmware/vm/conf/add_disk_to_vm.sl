...
####################################################
#!!
#! @description:                 - Add a new virtual (SCSI) disk to an existing virtual machine.
...
#! @input vm_disk_size:          - Size of the virtual disk to create in megabytes (MB).
#! @input thin_provision:        - Perform thin provisioning of the virtual disk.
#!                                 Valid values: "true", "false"
#!                                 Default value: false
#! @input eager_zero:            - Specify if the thick disk type (thin_provisioning input set to false) is eager zero
#!                                  or lazy zeroed. Data located on eager zeroed disks is zeroed out when the virtual
#!                                  disk is created. It migth take longer to create disks in this format
#!                                 Valid values: "true", "false"
#!                                 Default value: "false"
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.vm.conf.AddDiskToVM
   outputs: 
