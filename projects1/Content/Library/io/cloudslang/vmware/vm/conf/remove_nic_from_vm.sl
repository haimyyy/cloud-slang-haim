...
####################################################
#!!
#! @description:                 - Remove a Network Interface Card from a virtual machine.
...
#! @input device_number:         - Number of the NIC (Network adapter 1, Virtual Network Adapter, etc.).
#!                               - Example: "Network adapter 1" would be deviceNumber "1".
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.vm.conf.RemoveNICFromVM
   outputs: 
