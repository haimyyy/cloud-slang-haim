...
####################################################
#!!
#! @description:                 - Sets a VM memory size preserving its power state.
...
flow:
   ...
   -  keystore_password:
         ...
         required: false
   workflow:
   -  check_is_required_memory_provision:
         do:
            strings.string_equals:
            -  first_string: ${memory_provision_type}
         ...
         navigate:
         -  SUCCESS: SUCCESS
         -  FAILURE: get_current_vm_size
   -  get_current_vm_size:
         do:
            conf.get_vm_memory_size:
            -  host
            -  user
            -  password
            -  port
         ...
         publish:
            -  return_code
            -  failure_message
            -  initial_vm_memory_size: ${vm_memory_size if return_code=='0' else ''}
         navigate:
         -  SUCCESS: compute_memory_provision
         -  FAILURE: FAILURE
   -  compute_memory_provision:
         do:
            subflows.compute_provision:
            -  current_amount: ${initial_vm_memory_size}
            -  provision_type: ${memory_provision_type}
            -  provision_amount: ${new_memory_size}
         publish:
            -  return_code
            -  failure_message
            -  final_memory: ${computed_amount if return_code=='0' else ''}
         navigate:
   ...
   -  stop_vm:
         ...
         publish:
            ...
            -  failure_message
         navigate:
         -  SUCCESS: set_memory_size
         -  FAILURE: FAILURE
   -  set_memory_size:
         do:
            conf.set_vm_memory_size:
            -  host
            -  user
            -  password
            -  port
   ...
   -  check_vm_starts:
         ...
         -  NO_ACTION: preserve_initial_memory
         -  FAILURE: preserve_initial_memory
   ...
   -  preserve_initial_memory:
         do:
            ...
            -  virtual_machine
            -  vm_datacenter
            -  vm_memory_size: ${initial_vm_memory_size}
            -  auth_type
            -  proxy_host
            -  proxy_port
            -  proxy_username
   ...
   -  preserve_initial_power_state_failure:
         ...
         publish:
            -  return_code: "-1"
            -  failure_message: "Unable to set memory."
         navigate:
         -  SUCCESS: FAILURE
         -  FAILURE: FAILURE
   outputs:
   -  return_code
   -  failure_message
   -  return_result: ${failure_message if return_code!='0' else 'Successfully set the vm memory size.'}
   results:
   - FAILURE
   - SUCCESS
