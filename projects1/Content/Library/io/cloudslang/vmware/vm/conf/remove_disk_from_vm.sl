...
####################################################
#!!
#! @description:                 - Remove a virtual disk from an existing virtual machine.
...
#! @input disk_unlink:           - Delete the virtual disk file from the datastore?
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.vm.conf.RemoveDiskFromVM
   outputs: 
