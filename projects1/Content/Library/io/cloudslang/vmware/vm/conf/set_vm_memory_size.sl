...
####################################################
#!!
#! @description:                 - Sets the memory size for a virtual machine. Virtual machine cannot be in a suspended
#!                                  power state.  Memory hot add is supported if enabled for the virtual machine.
...
#! @input vm_memory_size:        - New memory size for the virtual machine in megabytes. This number must be a multiple of 4.
...
#! 2. Memory limits: The maximum value for 'vm_memory_size' is based on the virtual hardware version of the virtual machine.
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.vm.conf.SetVMMemorySize
   outputs: 
