...
####################################################
#!!
#! @description:                 - Delete a virtual machine from the inventory.
...
#! @output return_result:        - This is the primary output. In case of success returns the operation result. In case of error
#!                                  returns error message
#!                                 Example: "Virtual machine was removed".
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.vm.DeleteVM
   outputs: 
