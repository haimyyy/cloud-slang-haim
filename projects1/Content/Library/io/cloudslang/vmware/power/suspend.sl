...
#!                                  check_guest_running_delay must be provided. This input will be used only if VM is
#!                                  powered off.
#!                                 Default: true
...
#! @output failure_message:      - The error in case of failure
...
flow:
   ...
   -  is_requested_power_state:
         ...
         navigate:
         -  SUCCESS: SUCCESS
         -  FAILURE: unable_to_suspend_vm
   -  unable_to_suspend_vm:
         do:
            math.add_numbers:
            -  value1: "1"
            -  value2: "1"
         publish:
            -  failure_message: 'Unable to suspend the vm'
            -  return_code: "-1"
         navigate:
         -  SUCCESS: FAILURE
         -  FAILURE: FAILURE
