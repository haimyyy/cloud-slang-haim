...
####################################################
#!!
#! @description:                 - Restart (interrupt power) to virtual machine.
...
#! @result NO_ACTION:             - The operation completed with no action performed. (return_code 1)
#! Notes:
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.power.Restart
   outputs: 
