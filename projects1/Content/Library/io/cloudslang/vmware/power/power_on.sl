...
####################################################
#!!
#! @description:                 - Powers on the VM waiting for VM tools to run.
...
#! @input wait_guest:            - If this is true the VM will wait for guest to start (requires VM tools), otherwise
#!                                  it will just start the VM. If this input is provided retries and
...
#! @result SUCCESS:              - The machine has been powered on (return_code 0)
...
flow:
   ...
   -  is_requested_power_state:
         ...
         -  FAILURE: unable_to_power_on_vm
   -  unable_to_power_on_vm:
         do:
            math.add_numbers:
            -  value1: "1"
            -  value2: "1"
         publish:
            -  failure_message: 'Unable to power on the vm'
            -  return_code: "-1"
         navigate:
         -  SUCCESS: FAILURE
         -  FAILURE: FAILURE
   ...
   -  loop:
         ...
         -  EQUALS: tools_not_running
         -  LESS_THAN: tools_not_running
   -  tools_not_running:
         do:
            math.add_numbers:
            -  value1: "1"
            -  value2: "1"
         publish:
            -  failure_message: 'The tools did not start.'
            -  return_code: "-1"
         navigate:
         -  SUCCESS: FAILURE
         -  FAILURE: FAILURE
   ...
   -  sleep:
         ...
         navigate:
         -  SUCCESS: get_vm_tools_running_status
         -  FAILURE: FAILURE
   -  get_vm_tools_running_status:
         do:
            guest.get_vm_tools_running_status:
            -  host
            -  user
            -  password
            -  port
         ...
         publish:
            -  failure_message
            -  running_status: ${return_result}
            -  return_code
         navigate:
         -  SUCCESS: check_is_running
         -  FAILURE: FAILURE
   -  check_is_running:
         do:
            strings.string_equals:
            -  first_string: ${running_status}
            -  second_string: "guestToolsRunning"
            -  ignore_case: "true"
         navigate:
         -  SUCCESS: SUCCESS
         -  FAILURE: loop
