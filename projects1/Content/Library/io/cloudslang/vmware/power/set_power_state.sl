...
####################################################
#!!
#! @description:                 - Sets the power state of virtual machine (poweredOn,poweredOff,suspended). Does nothing if the virtual machine is already in the desired power state.
...
#!                                  "uuid", "vmid"
#! @input vm_power_state:        - Virtual machine power state to set (poweredOn, poweredOff, suspended).
...
#! @output return_code:          - The return code of the operation. (0,-1,1)
#! @result SUCCESS:              - The machine power state has been changed (return_code 0)
#! @result FAILURE:              - An exception occured (return_code -1)
#! @result NO_ACTION:            - The machine power state was already in the desired power state (return_code 1)
#! Notes:
...
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.power.SetPowerState
   outputs: 
