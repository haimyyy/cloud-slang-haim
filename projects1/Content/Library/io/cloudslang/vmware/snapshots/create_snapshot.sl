...
####################################################
#!!
#! @description:                 - Create a snapshot of an existing virtual machine disks and optionally the virtual
#!                                  machine memory if it is running.
...
#!                                 Default: 800
#! @input snapshot_name:         - Name of snapshot.
#! @input description:           - Description / annotation of the snapshot.
#! @input snapshot_mem:          - Snapshot virtual machine memory as well if virtual machine is running?
#!                                 Valid inputs: true, false
#!                                 Default is true.
#! @input quiesce:               - Quiesce guest filesystem if vmware tools is install on guest os and virtual machine is running?
#!                                 Valid inputs: true, false
#!                                 Default is true.
...
#!!#
####################################################
namespace: io.cloudslang.vmware.snapshots
operation: 
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.snapshots.CreateSnapshot
   outputs: 
