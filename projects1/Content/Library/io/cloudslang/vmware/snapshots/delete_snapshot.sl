...
####################################################
#!!
#! @description:                 - Delete an existing snapshot of a virtual machine or all snapshots of a virtual machine.
...
#!                                 Default: 800
#! @input snapshot_name:         - Name of snapshot; if empty removing all snapshots.
#! @input remove_children:       - Remove children of snapshot in addition to the named snapshot?
#!                                 Valid values: "true", "false"
#!                                 Default: "false"
#! @input remove_all_snapshots:  - Remove all snapshots?
#!                                 Valid values: "true", "false"
#!                                 Default: "false"
...
operation: 
   ...
   -  removeAllSnapshots: 
         private: true
         default: ${get("remove_all_snapshots", "")}
         sensitive: false
         required: false
   -  auth_type:
         default: "basic"
   ...
   java_action:
      ...
      method_name: execute
      class_name: io.cloudslang.content.actions.vmware.snapshots.DeleteSnapshot
   outputs: 
